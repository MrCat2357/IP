...
def f(x):
    ...
    return -y + np.array([
        ...
        np.sqrt((x1 - x5)**2 + (y1 - y5)**2),
        np.sqrt((x1 - x6)**2 + (y1 - y6)**2),
        np.sqrt((x2 - x3)**2 + (y2 - y3)**2),
        np.sqrt((x2 - x4)**2 + (y2 - y4)**2),
        np.sqrt((x2 - x5)**2 + (y2 - y5)**2),
        np.sqrt((x2 - x6)**2 + (y2 - y6)**2),
        np.sqrt((x3 - x4)**2 + (y3 - y4)**2),
        np.sqrt((x3 - x5)**2 + (y3 - y5)**2),
        np.sqrt((x3 - x6)**2 + (y3 - y6)**2),
        np.sqrt((x4 - x5)**2 + (y4 - y5)**2),
        np.sqrt((x4 - x6)**2 + (y4 - y6)**2),
        np.sqrt((x5 - x6)**2 + (y5 - y6)**2)
    ])
...
for i in range(5):
    print(f"x{i+2} = {x[2*i+1]:.6f}, y{i+2} = {x[2*i]:.6f}")
