...
# Início da medição de tempo e uso de recursos
...
# Otimização com método SLSQP
resultado = minimize(func_objetivo, chute_inicial, method='SLSQP', options={'disp': True})

# Fim da medição de tempo e uso de recursos
tempo_fim = time.time()
...
# Mostrar tempo e uso de recursos
